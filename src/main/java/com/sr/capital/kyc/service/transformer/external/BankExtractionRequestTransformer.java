...
import com.sr.capital.kyc.external.request.BankExtractionRequest;
...
@Service
public class BankExtractionRequestTransformer implements ExternalRequestTransformer {
    ...
    public <T extends IdfyBaseRequest<?>> T transformRequest(DocOrchestratorRequest request) {
        ...
        BankExtractionRequest extractionRequest = BankExtractionRequest.builder()
