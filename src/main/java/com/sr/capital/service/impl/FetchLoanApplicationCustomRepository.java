 ...
 */
    ...
    public List<Object[]> findLoanDetails(IcrmLoanRequestDto icrmLoanRequestDto) {
        ...
        sql.append("las.total_recoverable_amount AS recoverableAmount, la.vendor_status AS vendorStatus ,ld.interest_amount_at_disbursal ,la.state,DATE_FORMAT(la.loan_submitted_at,'%Y-%m-%d %H:%i:%s') as loanSubmittedAt ");
