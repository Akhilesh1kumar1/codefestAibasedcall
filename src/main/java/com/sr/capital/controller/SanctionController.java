...
public class SanctionController {
    ...
    @GetMapping("")
    public GenericResponse<SanctionDto> getSanctionDetails(@RequestParam(name = "loan_application_id") UUID loanApplicationId,@RequestParam(name = "loan_vendor_name") String loanVendorName) throws Exception {
