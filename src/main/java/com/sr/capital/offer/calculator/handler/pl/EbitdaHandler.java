...
public class EbitdaHandler implements ScopeHandler {
    ...
    public double handle(OfferCalculatorRequestDto customInputData, Parameter parameter) {
        if (parameter.getName() == ParameterName.EBITDA) {
            double value = customInputData.getEbitda(); // Assuming customInputData has a method to get EBITDA
