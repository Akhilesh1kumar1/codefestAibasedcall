...
public class LeverageHandler implements ScopeHandler {
    ...
    public double handle(OfferCalculatorRequestDto customInputData, Parameter parameter) {
        if (parameter.getName() == ParameterName.LEVERAGE) {
            double value = customInputData.getLeverage(); // Assuming customInputData has a method to get leverage
