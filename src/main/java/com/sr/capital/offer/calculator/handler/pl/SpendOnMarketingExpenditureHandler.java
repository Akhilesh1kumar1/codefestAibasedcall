...
public class SpendOnMarketingExpenditureHandler implements ScopeHandler {
    ...
    public double handle(OfferCalculatorRequestDto customInputData, Parameter parameter) {
        if (parameter.getName() == ParameterName.SPEND_ON_MARKETING_EXPENDITURE) {
            BigDecimal value = customInputData.getSpendOnMarketingExpenditure(); // Assuming customInputData has a method to get marketing expenditure
